...
class TrackableDateModel(models.Model):
    ''' Abstranct model to track the creation/updated date for a model. '''
...
class ChatSession(TrackableDateModel):
    '''
        Chat session.
        The uri's are generated by taking the first 15 charactes from a UUID
    '''
    owner = models.ForeignKey(User, on_delete=models.PROTECT)
    uri = models.URLField(default=_generated_unique_uri)
